...
define(['./workbox-13942bd7'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.fdh75rv2iok"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/\/api\/(auth\/me|user\/emergency-contacts)/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/\/api\/sos\/(active|history)/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/\/api\/routes\/.*/i, new workbox.StaleWhileRevalidate({
